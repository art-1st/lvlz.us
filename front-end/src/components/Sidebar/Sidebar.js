...
import { MdTimeline, MdSearch } from 'react-icons/md';
import { IoIosToday, IoIosMail, IoMdMenu } from 'react-icons/io';
...
class Sidebar extends Component {
  ...
  menus = [
    ...
    // },
    {
      ...
      icon: IoIosToday,
      title: "투데이",
      isActive: this.props.menu === "today",
      isDisabled: true
    },
    {
      url: "/calendar",
    ...
    return (
      <>
        <header className={`${ styles.header } ${ this.state.isExpanded ? styles['is-expanded'] : '' }`}>
          ...
          <nav className={ styles.nav }>
            <div className="hb-menu">
              <button onClick={(e) => { this.toggleExpand(e) }} title="메뉴">
        ...
        </header>
        {
          ...
          <div className={ styles['sidebar-dimmer'] } onClick={(e) => { this.toggleExpand(e) }} />
        }
      </>
    )
  }
